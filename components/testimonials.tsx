      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card 
              key={index} 
              className="bg-slate-900/40 border border-white/5 hover:border-white/10 backdrop-blur-md rounded-2xl hover:shadow-2xl transition-all duration-300 flex flex-col justify-between"
            >
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">
                      {testimonial.role} at <span className="text-slate-300 font-medium">{testimonial.company}</span>
                    </p>
                  </div>
                </div>
              </CardContent>
